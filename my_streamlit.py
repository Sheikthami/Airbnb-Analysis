...
st.set_page_config(page_title="AirBnb-Analysis by Sheik Abdul Kather!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Home":
 ...
 st.subheader("Airbnb is an American San Francisco-based company operating an online marketplace for short- and long-term homestays and experiences. The company acts as a broker and charges a commission from each booking. It help you make an informed decision about whether or not to invest in a market, convert your Airbnb and give you insights about how you perform against the competition. The company is credited with revolutionizing the tourism industry, while also having been the subject of intense criticism by residents of tourism hotspot cities like Barcelona and Venice for enabling an unaffordable increase in home rents, and for a lack of regulation.")
...
#----------------Contact-----------------#
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"SHEIK ABDUL KATHER"}')
    mail = (f'{"Mail :"}  {"sheikthami001@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
                "LINKEDIN": "https://www.linkedin.com/in/sheik-abdul-kather/"}
    col1, col2 = st.columns(2)
    col1.image(Image.open("C:\\Projects\\airbnb\\Sheik Abdul Kather.jpg"), width=300)
